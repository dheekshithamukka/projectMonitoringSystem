...
while($row = mysqli_fetch_array($res)) { 
  ...
  <div class="card-body">
    <h5 class="card-title">
          <a href="igdetails.php?pn=<?php echo $entry?>&guide=<?php echo $r?>" style="text-decoration: none; color: black;"><?php echo $i.". ". $entry ; 
...
<html>
<head>
<link rel="stylesheet" href="tableig3.css">
...
while($row = mysqli_fetch_array($res)) {
        ...
        <div class="pro">
            ...
            <div class="card" style="width: 18rem;">
  <div class="card-body">
    <h5 class="card-title"><a href="prodetails.php?pn=<?php echo $entry ?>" style="text-decoration: none; color: black;">
                <?php echo $i.". ". $entry ; 
        ?></a></h5>
        Project domain: 
        <?php 
