...
<br />
			...
			Already a member? <a href="prclogin.php">Login</a>
		</div>
        </form>
<!-- form -->
...
$sql="insert into prcreg (prcName,prcRollNo,prcEmail,prcPhone,prcBranch,prcPassword,imageType, imageData) values('$name','$roll','$email','$phone','$branch','$password', '{$imageProperties['mime']}', '{$imgData}')";
$res=mysqli_query($con,$sql) or die("<b>Error:</b> Problem on Image Insert<br/>" . mysqli_error($con));
if($res)
{
echo "Record successfully inserted";
header('location:prclogin.php');
}
else{
