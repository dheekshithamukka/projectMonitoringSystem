...
$sql="insert into adminreg (adminName,adminRoll,adminEmail,adminPhone,adminBranch,adminPassword,imageType, imageData) values('$name','$roll','$email','$phone','$branch','$password', '{$imageProperties['mime']}', '{$imgData}')";
